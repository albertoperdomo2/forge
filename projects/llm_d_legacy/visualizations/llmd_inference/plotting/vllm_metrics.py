...
class VLLMMetricsReport:
    ...
    def do_plot(self, *args):
        ...
        header.append(
            html.P(
                "Comprehensive analysis of VLLM inference server metrics from User Workload Monitoring"
            )
        )
        ...
        header.append(
            html.P("Overall request processing time and throughput from client perspective")
        )
        ...
        header.append(
            html.P(
                "Critical metric for perceived responsiveness - time until first token is generated"
            )
        )
        ...
        header.append(
            html.P("Detailed breakdown of request processing: prefill, decode, and queue times")
        )
