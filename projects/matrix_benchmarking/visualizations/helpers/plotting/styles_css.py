...
STYLE_INFO_CARD_BODY = {"flex": "1", "padding": "0"}
...
STYLE_DETAILS_CONTENT = {"padding": "1.25rem"}

STYLE_BENCHMARK_SECTION = {"margin-bottom": "2rem"}
...
STYLE_SMALL_TEXT = {"color": "#6c757d", "font-size": "0.8rem"}

STYLE_H4 = {"margin-top": "1rem"}
