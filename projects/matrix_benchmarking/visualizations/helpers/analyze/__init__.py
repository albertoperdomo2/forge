...
def prepare_regression_data(
    comparison_keys, ignored_keys, rewrite_settings, sorting_keys=[], ignored_entries={}
):
    ...
    for ref_entry in common.Matrix.all_records():
        ...
        def get_name(settings):
            return (
                getattr(settings, comparison_keys[0])
        ...
        for entry in common.LTS_Matrix.similar_records(
            kpi_settings,
